...
parser = argparse.ArgumentParser(
    description='Skip_Generative_VAE Model for CORE-VAE')
...
parser.add_argument('--early_stopping_epochs', type=int, default=30, metavar='ES',
                    help='number of epochs for early stopping')

parser.add_argument('--warmup', type=int, default=30, metavar='WU',
...
parser.add_argument('--model_name', type=str, default='baseline', metavar='MN',
                    help='model name: baseline, corevae')
...
# dataset
parser.add_argument('--dataset_name', type=str, default='ciao', metavar='DN',
                    help='name of the dataset:  yelp, libraraything, epinions')
...
def run(args, kwargs):
    ...
    model_name = args.dataset_name + '_' + args.model_name + '_' + \
        ...
        '_z1(' + str(args.z1_size) + ')' + \
        '_z2(' + str(args.z2_size) + ')'
    ...
    elif args.model_name == 'corevae':
        from models.COREVAE import VAE
    else:
    ...
    experiment_vae(args, train_loader, val_loader, test_loader,
                   model, optimizer, dir, log_dir, model_name=args.model_name)
    # ======================================================================================================================
